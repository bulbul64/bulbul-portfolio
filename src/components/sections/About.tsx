    ...
    >
      ...
      >
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {['HTML5', 'CSS3', 'JavaScript', 'React', 'Next.js', 'Tailwind CSS', 'TypeScript'].map((skill, i) => (
                <motion.span
                  key={i}
        ...
        >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              >
                <svg width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {/* Code Lines */}
                  <rect x="5" y="8" width="52" height="4" rx="2" fill="none" stroke="#3b82f6" strokeWidth={1}/>
                  <rect x="5" y="16" width="52" height="4" rx="2" fill="none" stroke="#8b5cf6" strokeWidth={1}/>
                  <rect x="5" y="24" width="52" height="4" rx="2" fill="none" stroke="#ec4899" strokeWidth={1}/>
                  
                  {/* Function Curly Braces */}
                  <path d="M13 6.5c0-3.2 2.6-5.7 5.7-5.7s5.7 2.6 5.7 5.7v13a5.7 5.7 0 0 1-5.7 5.7h-.1c-3.1 0-5.6-2.5-5.6-5.6" stroke="#fbbf24" strokeWidth={1}/>
                  <path d="M83 6.5c0-3.2-2.6-5.7-5.7-5.7s-5.7 2.6-5.7 5.7v13a5.7 5.7 0 0 0 5.7 5.7h.1c3.1 0 5.6-2.5 5.6-5.6" stroke="#fbbf24" strokeWidth={1}/>
                </svg>
              </motion.div>
            </div>
          ...
          >
            Let&apos;s Talk! 
            <motion.svg className="w-5 h-5 inline-block ml-1 -translate-y-1 opacity-0 group-hover:opacity-100 group-hover:-translate-y-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
