    ...
    <footer className="mt-20 bg-transparent">
      <div className="mx-auto max-w-6xl px-6 py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {/* LEFT - BRAND */}
          <div>
            <h2 className="text-2xl font-semibold tracking-tight">My Logo</h2>

            <p className="mt-4 text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed max-w-sm">
              Frontend Developer focused on building clean, modern and user-friendly web
              experiences.
            </p>

            {/* SOCIAL LINKS */}
            <div className="flex items-center gap-4 mt-5 text-zinc-500 text-lg">
              <a href="https://github.com/bulbul64/" target="_blank">
              ...
              <a
                ...
                target="_blank"
              >
                <FaLinkedin className="hover:text-black dark:hover:text-white transition" />
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col md:items-end">
            <h3 className="text-sm font-medium text-zinc-500 mb-4">Navigation</h3>
        ...
        <div className="mt-12 pt-6 border-t border-zinc-200/50 dark:border-zinc-800/50 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-zinc-500">Built with Next.js, React & Tailwind CSS</p>
        </div>
      </div>
    </footer>
  );
